...
const ITEMS = [
  ...
  { id: 4, img: "/temp/about/india-today.png", title: "Brands", href: "https://www.indiatoday.in/magazine/supplements/home/story/20250728-news-events-inside-access-2757644-2025-07-18" },
...
const EcosystemSection = () => {
  ...
  return (
    ...
    >
      ...
      <div className="w-full bg-white overflow-hidden h-[350px] md:h-[350px] lg:h-[300px] flex items-end">
        <MarqueeFlow
          items={ITEMS}
          gap={5}
          speed={200}
