...
export const ShowcaseModal = ({
  ...
  const architectsText = Array.isArray(data?.architects)
    ? data.architects.join(" | ")
    : data?.architects;
    ...
    <AnimatePresence mode="wait">
      {isOpen && (
        <div className="fixed inset-0 z-[1300] flex items-center justify-center p-4">
          ...
          >
            {/* LEFT: Carousel */}
            <div className="relative w-full lg:w-[520px] lg:min-w-[520px] lg:max-w-[520px] h-[300px] lg:h-full bg-zinc-100 overflow-hidden flex-shrink-0">
              <motion.div
                animate={{
                  x: `-${currentSlide * 100}%`,
                }}
            ...
            <div className="flex-1 min-w-0 flex flex-col h-full bg-white relative overflow-hidden">
              ...
              {/* FOOTER */}
              <div className="flex justify-between items-center gap-6 px-8 lg:pl-12 py-4 border-t border-zinc-100 bg-white">
